...
int main()
{
    ...
    if (test0 < average)
        cout << test0 << " is less that the average test score." << endl;  

    if (test1 < average)
        cout << test1 << " is less that the average test score." << endl;

    if (test2 < average)
        cout << test2 << " is less that the average test score." << endl;

    if (test3 < average)
        cout << test3 << " is less that the average test score." << endl;

    if (test4 < average)
        cout << test4 << " is less that the average test score." << endl;
