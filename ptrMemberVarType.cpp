//Pointer Member Variable Type function. 
...
int main()
{
	...
	cout << "Line 25: After a call to the function testCopyConst, " << endl
		  << "		listOne is: ";
...
void testCopyConst(ptrMemberVarType temp)
{
	cout << "Line 29: *** Inside the function testCopyConst ***" << endl;
	...
	cout << "Line 37: *** Exiting the function testCopyConst ***" << endl;
}
